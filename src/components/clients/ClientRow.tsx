...
export default function ClientRow({
  ...
  return (
    <tr
      ...
      tabIndex={0}
      className="cursor-pointer transition-colors hover:bg-gray-50 focus:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#1B2E6B]"
    >
      {children}
    </tr>
  );
