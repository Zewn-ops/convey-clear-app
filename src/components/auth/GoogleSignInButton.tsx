...
// (Auth → Providers → Google) — no-op error toast until then. On success the
// browser redirects to Google, then back to /api/auth/callback (role-routed).
export default function GoogleSignInButton({ label = "Continue with Google" }: { label?: string }) {
  ...
  async function signIn() {
    ...
    // success → browser navigates away to Google.
  }
